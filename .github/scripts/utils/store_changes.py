...
def storeForecasts (forecasts):
    ...
    if out_data['models']:
        db_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "..", "..", "..", "tree", "main", ".github", "data-storage", "changes_db.json")
...
def storetMetaData (metadata):
    ...
    db_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "..", "..", "..", "tree", "main", ".github", "data-storage", "metadata_db.json")
