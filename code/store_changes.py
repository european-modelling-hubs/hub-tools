...
def storeForecasts (forecasts):
    ...
    if out_data['models']:
        ...
        db_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "../../../repo/.github/datastorage/changes_db.json")
...
def storetMetaData (metadata):
    ...
    db_path = "/home/runner/work/flu-forecast-hub/flu-forecast-hub/./repo/.github/datastorage/metadata_db.json"
